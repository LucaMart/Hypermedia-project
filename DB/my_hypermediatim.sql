...
--
-- Host: 127.0.0.1
-- Creato il: Giu 29, 2016 alle 13:35
...
CREATE TABLE `device` (
  ...
  `AdditionalColors` tinyint(1) DEFAULT NULL,
...
INSERT INTO `device` (`Name`, `Category`, `SubCategory`, `ImagePath`, `Vendor`, `Model`, `Characteristics`, `Price`, `Specifications`, `IncludedInThePrice`, `Outlet`, `AdditionalColors`, `InPromotion`, `PromotionCategory`) VALUES
('Beats Solo2 On-Ear Headphones', 'TV and SmartLiving', 'others', 'Images/Devices/TV and SmartLiving/beats-solo2-on-ear-red-1.png', NULL, NULL, '', '199,90 &euro;', NULL, NULL, NULL, 1, NULL, 'Mobile'),
('Chiavetta TIM 42.2', 'Modems And Networking', 'Internet Keys', 'Images/Devices/Modem e Networking/Chiavetta42.2.png', NULL, NULL, '', '29,90 &euro;', NULL, NULL, NULL, NULL, NULL, NULL),
('iPhone 6S', 'Smartphones And Phones', 'Smartphone', 'Images/Devices/Smartphone e telefoni/apple-iPhone6s_SpGry-1.png', NULL, NULL, 'iOs', '789,90 &euro;', NULL, NULL, NULL, NULL, NULL, NULL),
('LG G5', 'Smartphones And Phones', 'Smartphone', 'Images/Devices/Smartphone e telefoni/LG_G5_titan_01_1.png', NULL, NULL, 'Android', '699,90 &euro;', NULL, NULL, NULL, NULL, NULL, NULL),
('LG Nexus 5x', 'Smartphones And Phones', 'Smartphone', 'Images/Devices/Smartphone e telefoni/LG-NEXUS5-BLACK-5.png', NULL, NULL, 'Android', '449,90 &euro;', NULL, NULL, NULL, NULL, NULL, NULL),
('Polar Loop Activity Tracker', 'TV and SmartLiving', 'Smartwatch', 'Images/Devices/TV and SmartLiving/Polar_loop_blk_760x760.png', NULL, NULL, '', '99,90 &euro;', NULL, NULL, NULL, NULL, NULL, NULL),
('Samsung Galaxy Gear S', 'TV and SmartLiving', 'Smartwatch', 'Images/Devices/TV and SmartLiving/samsung-galaxy-gear-s-1_0.png', NULL, NULL, '', '389,90 &euro;', NULL, NULL, NULL, NULL, NULL, NULL),
('Samsung Galaxy S7', 'Smartphones And Phones', 'Smartphone', 'Images/Devices/Smartphone e telefoni/SAMSUNG_S7_Beige_02.png', 'Samsung', 'Smartphone Galaxy S7 Edge', 'Android OS 6.0\r\nDisplay 5.5\r\nOctaCore CPU (QuadCore 2.3GHz + QuadCore 1.6 GHz)', '729,90 &euro;', '<h4>Technology</h4>\n<p>4G cat.9/HSDPA42/UMTS/EDGE/GPRS Frequenze 850/900/1800/1900/2100</p>\n<h4>Connectivity</h4>\n<p>Wi-Fi - Bluetooth - Micro USB - NFC</p>\n<h4>GPS</h4>\n<p>integrated</p>\n<h4>Display</h4>\n<p>5.1&quot; 16 Million colors - Touch</p>', '<h4>22 GB free of 4G Internet for 30 days</h4>\n<p>You can access all the functions of TIMvision and watch TV in the REPLAY FREE TV section. Using your credit card (Visa, Mastercard or American Express) you can purchase the movies of the Videostore section and the subscription to TIMvision TV. But remember, to keep your subscription active it is necessary to store the data of your credit card.</p>\n<br/>\n<h4>TIM card with 5 euros of pre-paid traffic</h4>\n<p>Only TIM gives you the TIM SIM-Plus with 128 Kbytes of memory. The only card that allows you to exploit the full potential of your GSM and UMTS mobile phone, by offering the most advanced and innovative services.</p>', 0, 1, NULL, NULL),
('Samsung Smart TV 50', 'TV and SmartLiving', 'SmartTV', 'Images/Devices/TV and SmartLiving/SmartTVSamsung.png', 'Samsung', 'Model 50JU6400 - 50&quot;', 'Ultra HD - 4K 3840 x 2160\nSoundbar HW-J250 included\nTIMvision included', '26,08 &euro; for 36 months', '<p>\r\nSeries: J5500 <br/>\r\nType: Full HD Led TV<br/>\r\nSmart Hub: Yes<br/>\r\n</p>\r\n<p>\r\nMotion Rate: 60&deg;<br/>\r\nScreen size: 49.5&quot; measured diagonally.<br/>\r\nResolution: 1920 x 1080<br/>\r\n<p>\r\nProcessor: Quad Core Bluetooth<br/>\r\nOSD Language: English, Spanish, French \r\n</p>\r\n<p> HDMI: 3      USB: 2     Ethernet: 1</p>\r\n<p>Weight: 29.5 lib.</p>', '<h4>SoundBar - HWJ250</h4>\r\n                     <img class="imageInTab" src="Images/Devices/Soundbar-HWJ250.png"/>\r\n                    <p>A great audio experience in a compact format.\r\nThe perfect companion for your TV, it creates a great sound whatever you''re watching. Two built-in speakers provide a crisp, high and well-balances mid-range, while another two built-in woofers take care of the bass. Enjoy the biggest sound for your TV Complement the images you see on screen with realistic, dramatic natural sound.</p>\r\n                    <h4>Subscription to the TIM Vision SmartLife Service</h4>\r\n                    <p>With the TIMvision subscription you can choose between cartoons, movies, TV series, documentaries, music and the last seven days of the main RAI channels and La7.\r\nYou can also purchase videos and films on Videostore.\r\n</p>', 1, 1, 1, 'TV&Entertainment, installments'),
('Tecnoware ERA Plus 900', 'TV and SmartLiving', 'others', 'Images/Devices/TV and SmartLiving/slider_era_plus_900_tecnoware_1.png', NULL, NULL, '', '79,90 &euro;', NULL, NULL, NULL, NULL, NULL, NULL),
('TIM  Modem 4G Wi-Fi', 'Modems And Networking', ' Modems', 'Images/Devices/Modem e Networking/modem_wifi_4g.png', NULL, NULL, '', '79,90 &euro;', NULL, NULL, NULL, NULL, NULL, NULL),
('TIM Facile Maxi', 'Smartphones And Phones', 'Phone', 'Images/Devices/Smartphone e telefoni/slider_cordless_facile_maxi_1.png', NULL, NULL, '', '39,90 &euro;', NULL, NULL, NULL, NULL, NULL, NULL),
('TIM Facile Smile', 'Smartphones And Phones', 'Phone', 'Images/Devices/Smartphone e telefoni/prodotti_slider_facile_smile_rosso_01.png', NULL, NULL, '', '39,90 &euro;', NULL, NULL, NULL, NULL, 1, 'Landline'),
('TIM Modem Adsl Wi-Fi', 'Modems And Networking', 'Modems', 'Images/Devices/Modem e Networking/modem-adsl-new.png', NULL, NULL, '', '69,00 &euro;', NULL, NULL, NULL, NULL, NULL, NULL),
('TIM Modem Wi-Fi Car Pack 4G', 'Modems And Netowrking', 'Modems', 'Images/Devices/Modem e Networking/TIM_Pack_WiFi_Car.png ', NULL, NULL, '', '99,90 &euro;', NULL, NULL, NULL, NULL, NULL, NULL),
('ZyXEL Repeater Wi-Fi AC750', 'Modems And Networking', '', 'Images/Devices/Modem e Networking/repeater-zyxel.png', NULL, NULL, '', '49,90 &euro;', NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `devicecolors` (
  ...
  `ColoredImagePath` varchar(511) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `devicecolors` (`Name`, `Color`, `ColoredImagePath`) VALUES
('Beats Solo2 On-Ear Headphones', 'red', 'Images/Devices/TV and SmartLiving/beats-solo2-on-ear-red-1.png'),
('Samsung Galaxy S7', 'beige', 'Images/Devices/Smartphone e telefoni/SAMSUNG_S7_Beige_02.png'),
('Samsung Galaxy S7', 'black', 'Images/Devices/Smartphone e telefoni/SamsungGalaxyS7Black.jpg'),
('Samsung Galaxy S7', 'white', 'Images/Devices/Smartphone e telefoni/SamsungGalaxyS7White.jpg'),
('Samsung Smart TV 50', 'black', 'Images/Devices/TV and SmartLiving/SmartTVSamsung.png');
...
ALTER TABLE `as-descriptiondiv`
  ADD PRIMARY KEY (`Title`,`ASServiceSubcategory`,`ASServiceName`);
...
--
-- Indici per le tabelle `devicecolors`
--
ALTER TABLE `devicecolors`
...
ALTER TABLE `faquestion`
  ADD PRIMARY KEY (`Question`,`ASServiceID`);
