...
--
-- Host: 127.0.0.1
-- Creato il: Giu 16, 2016 alle 14:35
...
INSERT INTO `assistanceservice` (`Name`, `Category`, `SubCategory`, `Highlights`, `ID`) VALUES
('ADSL modem', 'Technical support and configuration', 'ADSL and fiber', NULL, 1),
('Configurations and manuals', 'Technical support and configuration', 'Smartphone and tablet', 1, 2),
('Configure online', 'Technical support and configuration', 'Smartphone and tablet', NULL, 3),
('Devices for Tim Games', 'SmartLife', 'TIM Games', NULL, 4),
('Devices for Tim Music', 'SmartLife', 'TIM Music', NULL, 5),
('Devices for Tim Reading', 'SmartLife', 'TIM Reading', NULL, 6),
('Devices for Tim Vision', 'SmartLife', 'TIM Vision', NULL, 7),
('Discover Tim Games', 'SmartLife', 'TIM Games', NULL, 8),
('Discover Tim Music', 'SmartLife', 'TIM Music', NULL, 9),
('Discover Tim Reading', 'SmartLife', 'TIM Reading', NULL, 10),
('Discover TIM Vision', 'SmartLife', 'TIM Vision', NULL, 11),
('Enable/disable content services (CSP) and phone services', 'Line management and services', 'Mobile', NULL, 12),
('Enable/disable phone services', 'Line management and services', 'Landline', NULL, 13),
('Fiber', 'Technical support and configuration', 'ADSL and fiber', 1, 14),
('How to recharge', 'Line management and services', 'Mobile', NULL, 15),
('Inbox configuration', 'Technical support and configuration', 'Mail', NULL, 16),
('Installments promotions', 'Monitoring costs and payments', 'Mobile', NULL, 17),
('Internet surfing', 'Monitoring costs and payments', 'Mobile', NULL, 18),
('Invoices and payments', 'Monitoring costs and payments', 'Landline', 1, 19),
('ISDN line', 'Technical support and configuration', 'Landline', NULL, 20),
('Join TIM with a mobile line', 'Line management and services', 'Do you need help to join TIM', NULL, 21),
('Landline issues', 'Technical support and configuration', 'Landline', NULL, 22),
('Line management', 'Line management and services', 'Landline', 1, 23),
('Mail configuration', 'Technical support and configuration', 'Smartphone and tablet', NULL, 24),
('Mail issues', 'Technical support and configuration', 'Mail', 0, 25),
('Mobile line management when you''re aboard', 'Line management and services', 'Mobile', NULL, 26),
('MyTim landline', 'Monitoring costs and payments', 'What can you do online', NULL, 27),
('MyTim mobile', 'Monitoring costs and payments', 'What can you do online', 1, 28),
('Navigation issues', 'Technical support and configuration', 'Navigation', NULL, 29),
('Navigation settings', 'Technical support and configuration', 'Navigation', NULL, 30),
('Network resource', 'Technical support and configuration', 'ADSL and fiber', NULL, 31),
('New Smart for landline and mobile ', 'Line management and services', 'Do you need help to join TIM', NULL, 32),
('Online recharge', 'Line management and services', 'What can you do online', NULL, 33),
('Online shopping', 'Line management and services', 'What can you do online', NULL, 34),
('Phone services guide', 'Technical support and configuration', 'Landline', NULL, 35),
('Premium online', 'Technical support and configuration', 'TV decoder', NULL, 36),
('Rechargeable', 'Monitoring costs and payments', 'Mobile', NULL, 37),
('Service management', 'SmartLife', 'TIM Games', NULL, 38),
('Service management', 'SmartLife', 'TIM Music', NULL, 39),
('Service management', 'SmartLife', 'TIM Reading', NULL, 40),
('Service management', 'SmartLife', 'TIM Vision', NULL, 41),
('Services for your smartphone', 'Technical support and configuration', 'Smartphone and tablet', NULL, 42),
('SIM management', 'Line management and services', 'Mobile', NULL, 43),
('Subscription', 'Monitoring costs and payments', 'Mobile', NULL, 44),
('Tim mail guide', 'Technical support and configuration', 'Mail', 0, 45),
('Tim SKY', 'Technical support and configuration', 'TV decoder', NULL, 46),
('Tim Vision', 'Technical support and configuration', 'TV decoder', NULL, 47),
('Username and password', 'Technical support and configuration', 'Mail', NULL, 48),
('Wi-fi repeater', 'Technical support and configuration', 'ADSL and fiber', NULL, 49),
('MyTim landline', 'Line management and services', 'What can you do online', NULL, 50),
('MyTim mobile', 'Line management and services', 'What can you do online', NULL, 51);
