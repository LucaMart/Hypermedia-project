...
CREATE TABLE `as-descriptiondiv` (
  ...
  `ASService-ID` int(11) DEFAULT NULL,
  `Order` int(5) NOT NULL,
  PRIMARY KEY (`Title`,`ASService-Subcategory`,`ASService-Name`)
...
-- Dump completed on 2016-06-20 10:12:37
